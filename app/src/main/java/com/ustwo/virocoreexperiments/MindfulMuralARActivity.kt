 ...
 */
class MindfulMuralARActivity : Activity(), ARScene.Listener {
    ...
    private fun onRenderCreate() {
        ...
        val teslaLogoTargetBmp = getBitmapFromAssets("mural.png")
    ...
    private fun initCarModel(groupNode: Node) {
        ...
        fbxCarNode.loadModel(mViroView!!.viroContext, Uri.parse("file:///android_asset/mural_animated_path.obj"), Object3D.Type.OBJ, object : AsyncObject3DListener {
    ...
    companion object {
        private val TAG = MindfulMuralARActivity::class.java.simpleName
    }
}